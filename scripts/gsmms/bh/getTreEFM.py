...
conditions = ["model.reactions.get_by_id('EX_ac(e)').flux>0",
              "model.reactions.get_by_id('EX_lac_D(e)').flux>0",
              "model.reactions.get_by_id('EX_tre(e)').flux<0"]
